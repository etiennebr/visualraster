...
```{r echo = FALSE, message = FALSE}
ggplot() + vr_geom_raster_seq(r_terrain[["aspect"]]) + ggtitle("aspect") + scale_fill_gradientn(colours = pal$circular2, limits = c(0, 2 * pi)) 

ggplot() + vr_geom_raster_seq(power_to_angle(r_terrain[["flowdir"]])) + ggtitle("flowdir") + scale_fill_gradientn(colours = pal$circular2, limits = c(0, 360)) 
```
